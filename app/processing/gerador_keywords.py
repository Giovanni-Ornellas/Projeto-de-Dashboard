...
from app.legislative.utils_legislativo import validar_tag
from app.semantic.embeddings import get_model

MODELO_NOME = settings.MODELO_NOME
...
if __name__ == "__main__":
    ...
    for arquivo in arquivos_db:
        ...
        arquivo_pkl = os.path.join(settings.PASTA_DADOS, f"keywords_embeddings_{sufixo}.pkl")
